        ...
        <div className="flex flex-col w-full h-full bg-white p-5">
            ...
            <div className="flex-1 overflow-y-auto flex flex-col gap-2 max-h-[200px] lg:max-h-none">
                {[...elements].reverse().map(element => (
                    <div
                        key={element.id}
                        className={`group flex items-center justify-between p-3 rounded-xl cursor-pointer transition-all duration-200 border ${element.id === selectedElementId
            ...
            {selectedElementId && selectedElement && (
                <div className="mt-4 pt-4 border-t border-gray-100 bg-gray-50/50 p-4 rounded-xl border border-gray-100">
